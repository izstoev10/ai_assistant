...
const file_auth_proto_rawDesc = "" +
	...
	"\vVerifyToken\x12\x18.auth.VerifyTokenRequest\x1a\x19.auth.VerifyTokenResponseB8Z6github.com/izstoev10/ai_assistant/services/auth;authpbb\x06proto3"
...
var file_auth_proto_depIdxs = []int32{
	...
	2, // 1: auth.Auth.VerifyToken:input_type -> auth.VerifyTokenRequest
	1, // 2: auth.Auth.Login:output_type -> auth.LoginResponse
	3, // 3: auth.Auth.VerifyToken:output_type -> auth.VerifyTokenResponse
